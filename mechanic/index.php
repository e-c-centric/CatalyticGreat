...
<head>
    ...
    <title>CatalyticGreat+ | Mechanic Vehicle Dashboard</title>
...
<body>
    ...
    <main class="container">
        <section class="search-container">
            <h1 class="text-center mb-3">Mechanic Vehicle Catalyst Dashboard</h1>
    ...
    <footer
        ...
        <div class="container">
            <p>&copy; 2025 CatalyticGreat+ | Mechanic Vehicle Dashboard</p>
        </div>
    </footer>
